...
with \textbf{back-tracking line search} to calculate \(x_min\)
...
\NormalTok{  eta\_values }\OtherTok{\textless{}{-}} \FunctionTok{rep}\NormalTok{(step\_size, max\_iter)  }\CommentTok{\# To store eta values used each iteration}
\NormalTok{  x0 }\OtherTok{\textless{}{-}} \FunctionTok{runif}\NormalTok{(}\DecValTok{1}\NormalTok{, }\AttributeTok{min=}\SpecialCharTok{{-}}\DecValTok{10}\NormalTok{, }\AttributeTok{max=}\DecValTok{10}\NormalTok{) }\CommentTok{\# our first guess is somewhere between 0{-}1}
...
\NormalTok{  \}}
  ...
  \FunctionTok{return}\NormalTok{(}\FunctionTok{list}\NormalTok{(}\AttributeTok{beta =}\NormalTok{ beta, }\AttributeTok{obj\_values =}\NormalTok{ obj\_values, }\AttributeTok{eta\_values =}\NormalTok{ eta\_values)) }\CommentTok{\# in this case, beta(predictors) are the x values, obj\_values are f(x), and eta is the step size }
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
